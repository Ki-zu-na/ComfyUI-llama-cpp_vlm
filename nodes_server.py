    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                ...
                "top_k": ("INT", {"default": 20, "min": 0, "max": 1000, "step": 1, "advanced": True}),
                "min_p": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 1.0, "step": 0.01, "advanced": True}),
                "repeat_penalty": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 2.0, "step": 0.01, "advanced": True}),
                "presence_penalty": ("FLOAT", {"default": 1.5, "min": 0.0, "max": 2.0, "step": 0.01, "advanced": True}),
                "n_gpu_layers": ("INT", {"default": 99, "min": 0, "max": 999, "step": 1, "advanced": True, "tooltip": "-ngl. 99 = everything on GPU, 0 = CPU."}),
                "image_max_tokens": ("INT", {
                    "default": 1024, "min": 0, "max": 8192, "step": 64, "advanced": True,
                ...
                "extra_args": ("STRING", {"default": DEFAULT_EXTRA_ARGS, "advanced": True, "tooltip": "Extra llama-server arguments appended verbatim."}),
